package org.firstinspires.ftc.teamcode.EncoderTesting;
...
public class Motion {
    ...
    static final double DRIVE_COUNTS_PER_MM_STRAIGHT = (HD_COUNTS_PER_REV * DRIVE_GEAR_REDUCTION) / WHEEL_CIRCUMFERENCE_MM/1.269;
    ...
    // Initialise Motion controllers
    private PIDController FrontLeftMotorPID;
    private PIDController FrontRightMotorPID;
    private PIDController BackLeftMotorPID;
    private PIDController BackRightMotorPID;
    ...
    public void motorFwdTargetPositions (float cmDistance, double speed) {
        ...
        int frontRightTarget = (int)(motor_front_right.getCurrentPosition() + (int)(cmDistance * DRIVE_COUNTS_PER_CM_STRAIGHT))*-1;
        int frontLeftTarget = (int)(motor_front_left.getCurrentPosition() + (int)(cmDistance * DRIVE_COUNTS_PER_CM_STRAIGHT))*-1;
        int backRightTarget = (int)motor_back_right.getCurrentPosition() + (int)(cmDistance * DRIVE_COUNTS_PER_CM_STRAIGHT);
        int backLeftTarget = (int)motor_back_left.getCurrentPosition() + (int)(cmDistance * DRIVE_COUNTS_PER_CM_STRAIGHT);
        ...
        while ((motor_front_left.isBusy() || motor_front_right.isBusy() || motor_back_left.isBusy() || motor_back_right.isBusy())&& notCloseToTarget(5)){
            motor_front_right.setPower(FrontRightMotorPID.calculate(frontRightTarget,motor_front_right.getCurrentPosition()));
            try {
                Thread.sleep(100);
            }
    ...
    **/
    ...
    public void rotate(int degrees, double power){
        ...
        **/
        ...
        double closeToFortyFive = target/45;
        target = Math.round(closeToFortyFive)*45;
        ...
        while (gap>1) {
            ...
            if (gap <=15){
                ...
                if (scaleFactor*power<0.1){
                    scaleFactor=0.1/power;
                }
